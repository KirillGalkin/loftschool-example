...
function isMatching(fullName, fullValue, chunk) {
    ...
    if (fullName.toLowerCase().indexOf(chunk.toLowerCase()) !== -1) {
        return true;
    }
    if (fullValue.toLowerCase().indexOf(chunk.toLowerCase()) !== -1) {
        return true;
    }
...
function createTableForCookies() {
